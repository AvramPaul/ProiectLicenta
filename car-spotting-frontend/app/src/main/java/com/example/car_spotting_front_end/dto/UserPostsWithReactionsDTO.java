...
public class UserPostsWithReactionsDTO {
    private Long id;
    private float score;
    ...
    public UserPostsWithReactionsDTO(Long id, float score, String carMake, String carModel, int carYear, String carImagePath, List<String> usersThatLiked, List<String> usersThatDisliked) {
        this.id = id;
        this.score = score;
